...
% - Revised section on cascades. Now uses compositional grammar, and
...
evaluate \code{v.$s$} to an object which is discarded,
then $e$ evaluates to $o$.
Otherwise $o$ is the null object.
If $e$ is initially conditional then $e$ evaluates to $o$;
%% TODO(eernst): With NNBD, this error cannot happen -- delete.
