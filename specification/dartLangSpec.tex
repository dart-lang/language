...
\item
  ...
  Therefore, every function must return an object.
...
\item If $r_i$ is not an instance of the built-in type \code{String},
  throw an \code{Error}.
\end{itemize}
...
\item \code{$im$.positionalArguments} evaluates to an unmodifiable list with the objects
