...
\LMHash{}%
Similarly, we introduce the notion of a
\IndexCustom{function-type bounded type}{type!function-type bounded}:
Every function type $T$
(\ref{functionTypes})
is a function-type bounded type,
with associated function type $T$;
if $B$ is function-type bounded with associated function type $T$ and
$X$ is a type variable with bound $B$
then $X$ is function-type bounded with associated function type $T$;
finally, if $B$ is function-type bounded with associated function type $T$ and
$X$ is a type variable
then $X \& B$ is function-type bounded with associated function type $T$.
...
\LMHash{}%
Otherwise, the static type of $f$ is function-type bounded
with some associated function type $F$.
