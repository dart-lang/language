...
%
% Apr 2025
% - Change rules about constants to be more consistent: Every constant
%   expression is also a potentially constant expression, and no potentially
%   constant expression requires a subexpression to be constant.
%
% Sep 2024
...
\item
  ...
  and $e_1$, \ldots{} , $e_n$ are potentially constant expressions.
  It is further a constant expression
  if $e_1$, \ldots{} , $e_n$ are constant expressions,
  and the list literal evaluates to an object.
...
\item
  ...
  It is further a constant expression
  if $e_1$, \ldots{} , $e_n$ are constant expressions,
  and the set literal evaluates to an object.
...
\item
  ...
  It is further a constant expression
  if $k_1$, \ldots{} , $k_n$ as well as $v_1$, \ldots{} , $v_n$
  are constant expressions,
  and the map literal evaluates to an object.
