...
%
% 2.4
% - Change specification of `await` to be type-safe.
%   The existing specification allowed predictable run-time type errors for
%   well-typed programs like
...
with a static context type of $T$ proceeds as follows:
First, the expression $e$ is evaluated to an object $o$.
...
\LMHash{}%
The static type of $a$ is \flatten{S} (\flatten{} is defined in section \ref{functionExpressions}) where $S$ is the static type of $e$.
