...
\LMHash{}%
The current scope for a documentation comment immediately preceding
the declaration of a function $f$ is the
\IndexCustom{formal parameter scope}{scope!formal parameter} of $f$.

\LMHash{}%
The current scope for a documentation comment immediately preceding
the declaration of a non-redirecting generative constructor $c$
with initializing formals is the
\IndexCustom{formal parameter initializer scope}{%
  scope!formal parameter initializer}of $c$.
