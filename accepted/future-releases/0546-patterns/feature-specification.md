...
to have an expression of type `void`][void whitelist]:

[void whitelist]:https://github.com/dart-lang/language/blob/f58f8c5d24eed253db41474a3149f7b79a274c63/specification/dartLangSpec.tex#L21981
...
`void`, which means that it can in turn only occur in a whitelisted location.
For example, `void f() => switch (null) { null => print('Got yer!') };` is OK.*
